          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                ...
                <a class="btn btn-primary" href="<?php echo route_to('user.create'); ?>">Add New User</a>
              </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td> 
                      <a class="btn btn-info" href="<?php echo route_to('user.view',$user['id']); ?>">Show</a>    
                      <a class="btn btn-primary" href="<?php echo route_to('user.edit',$user['id']); ?>">Edit</a>   
                      <a class="btn btn-danger" href="<?php echo route_to('user.delete',$user['id']); ?>">Delete</a> 
                    </td>
                  </tr>
                  <?php endforeach; ?>
                  <?php endif; ?>               
